					...
					<div class="ibox-content">
						<form method="get" class="form-horizontal">							
							<div class="form-group">
								<label class="col-sm-2 control-label">退货名称</label>
							...
							<div class="hr-line-dashed"></div>
							<div class="form-group">
								<label class="col-sm-2 control-label">退货客户</label>
							...
							<div class="form-group">
								<div class="col-sm-4 col-sm-offset-2">
									...
									<a
										href="${pageContext.request.contextPath}/admin/product/refunds/info/show"
								...
								type : "error",
									...
									if (isConfirm) {
										window.location.href = ctxpath
												+ '/admin/product/refunds/info/show';
									} else {
