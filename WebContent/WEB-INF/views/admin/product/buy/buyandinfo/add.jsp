...
<body class="gray-bg">
					...
					<div class="ibox-content">
						<form method="get" class="form-horizontal">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" id="datewant"  name="buyTime">
								</div>
							</div>
							<div class="hr-line-dashed"></div>
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="hidden" name="pkUid" value="${uId }">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control"  name="buyInfo">
									<input type="hidden" name="isInStorehouse" value="0">
								</div>
							</div>
							<div class="hr-line-dashed"></div>
							<div class="form-group">
								...
								<div class="radio i-checks">
									<label class="">
										<div class="iradio_square-green " style="position: relative;">
											<input type="radio" value="1" name="isSeasonal"
										...
										<div class="iradio_square-green" style="position: relative;">
											<input type="radio" checked="" value="0" name="isSeasonal"
												style="position: absolute; opacity: 0;">
											<ins class="iCheck-helper"
												style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 0;"></ins>
										</div> <i></i> 否
										...
										<tr>
											...
											<td>
												<div class="form-group col-sm-10">
													<select class="form-control m-b supplierselect" name="buyInfos[0].pkSpid"
																	id="firstselect" g="0">
											...
											<td>
												<div class="form-group col-sm-10">
													<input type="number" class="form-control" name="buyInfos[0].buyInfoNum">
												</div>
											</td>
											<td>
												<div class="form-group col-sm-10">
													<input type="text" class="form-control" name="buyInfos[0].buyInfoOther">
												</div>
											</td>
											<td></td>
	...
	+		'				name="buyInfos['+i+'].pkPid">'
					...
					+ '		<td>'
					+ '			<div class="form-group col-sm-10">'
					+ '				<input type="number" class="form-control" name="buyInfos['+i+'].buyInfoNum">'
					+ '			</div>'
					+ '		</td>'
					+ '		<td>'
					+ '			<div class="form-group col-sm-10">'
