				...
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						<form method="get" class="form-horizontal">
							<input type="hidden" class="form-control" name="pkPid"
								value="${product.pkPid}">
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control"
										name="productCategoryName" value="${product.productCategoryName}">
								</div>
							</div>
							...
							<input type="hidden" class="form-control"
								name="productCategoryNum" value="${product.productCategoryNum}">
							<!-- 								</div> -->
							<!-- 							</div> -->
							<!-- 							<div class="hr-line-dashed"></div> -->
							<div class="form-group">
								...
								<div class="col-sm-3">
									<div class="col-sm-10">
										<input type="text" class=" form-control"
											name="productCategoryPrice" value="${product.productCategoryPrice/100}">
									</div>
		...
		$('#firstselect')
				.click(
						function() {
							...
							$
									.ajax({
										url : "${pageContext.request.contextPath}/admin/product/update?getdata="
												+ $(this).val(),
										type : "POST",
										success : function(d) {
											$('#secondselect').empty();
		...
		$('#secondselect')
				.click(
						function() {
							...
							$
									.ajax({
										url : "${pageContext.request.contextPath}/admin/product/update?getdata2="
												+ $(this).val(),
										type : "POST",
										success : function(d) {
											$('#threadselect').empty();
							...
							$(".demo2")
									.click(
											function() {
												...
												$
														.ajax({
															url : "${pageContext.request.contextPath}/admin/product/update?methord=update",
															type : "POST",
															data : $("form")
																	.serialize(),
															success : function(
