							...
							<form role="form">
								<div class="form-group">
									<label>员工编号</label> <input type="text"
										placeholder="请输入您要添加的员工编号" class="form-control" name="empNo">
								</div>
								<div class="hr-line-dashed"></div>
								<div class="form-group">
									<label>员工名称</label> <input type="text"
										placeholder="请输入您要添加的员工名称" class="form-control" name="empName">
								</div>
								<div class="hr-line-dashed"></div>
								<div class="form-group">
									<label>员工性别</label>
									<div class="radio i-checks">
										<label class="">
											<div class="iradio_square-green " style="position: relative;">
												<input type="radio" checked="" value="1" name="empSex"
											...
											<div class="iradio_square-green" style="position: relative;">
												<input type="radio" value="0" name="empSex"
													style="position: absolute; opacity: 0;">
												<ins class="iCheck-helper"
													style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 0;"></ins>
											</div> <i></i> 女
								...
								<div class="form-group">
									<label>员工电话</label> <input type="text"
										...
										placeholder="请输入您要添加的员工电话" class="form-control">
								</div>
								<div class="hr-line-dashed"></div>
								<div class="form-group">
									...
									<div class="col-sm-8">
										<select class="form-control m-b" name="pkRid">
											<c:forEach var="role" items="${roles }">
												<option value="${role.pkRid}"<%-- ${firstProductCategory.pkPcid==pproductCategory.pid?'selected':''} --%>>${role.roleName}</option>
											</c:forEach>
