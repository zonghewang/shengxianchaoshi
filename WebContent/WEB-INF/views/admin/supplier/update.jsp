							...
							<div class="clearfix">
								...
								<div class="col-sm-6">
									<div class="form-group ">
										...
										<div class="col-sm-8">
											<select class="form-control m-b" id="productselect"
												name="pkPid">
		...
		$('#firstselect')
				.click(
						function() {
							...
							$
									.ajax({
										url : "${pageContext.request.contextPath}/admin/supplier/update?getdata="
												+ $(this).val(),
										type : "POST",
										success : function(d) {
											$('#secondselect').empty();
		...
		$('#secondselect')
				.click(
						function() {
							...
							$
									.ajax({
										url : "${pageContext.request.contextPath}/admin/supplier/update?getdata2="
												+ $(this).val(),
										type : "POST",
										success : function(d) {
											$('#threadselect').empty();
		...
		$('#threadselect')
				.click(
						function() {
							...
							$
									.ajax({
										url : "${pageContext.request.contextPath}/admin/supplier/update?getdata3="
												+ $(this).val(),
										type : "POST",
										success : function(d) {
											$('#productselect').empty();
							...
							$(".demo2")
									.click(
											function() {
												$
														.ajax({
															url : "${pageContext.request.contextPath}/admin/supplier/update?methord=update",
															type : "POST",
															data : $("form")
																	.serialize(),
															success : function(
