							...
							<form role="form">
									...
									<div class="radio i-checks">
										<label class="">
											<div class="iradio_square-green " style="position: relative;">
												<input type="radio" checked value="1" name="customerSex"
													class="showother" style="position: absolute; opacity: 0;">
								...
								<div class="form-group">
									<label>年龄</label> <input type="number" minlength="1"
										maxlength="2" name="customerAge" class="form-control"
										placeholder="请输入您要添加的会员年龄" min="1" max="150" />
								</div>
								<div class="hr-line-dashed"></div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="radio i-checks">
										<label class="">
											<div class="iradio_square-green " style="position: relative;">
												<input type="radio" checked="" value="1" name="isVip"
													class="showother" style="position: absolute; opacity: 0;">
												<ins class="iCheck-helper"
													style="position: absolute; top: 0%; left: 0%; display: block; width: 100%; height: 100%; margin: 0px; padding: 0px; background: rgb(255, 255, 255); border: 0px; opacity: 0;"></ins>
											</div> <i></i> 是
											...
											<div class="iradio_square-green" style="position: relative;">
												<input type="radio" value="0" name="isVip" class="showother"
								...
								<div id="otherinfo">
									...
									<div class="hr-line-dashed"></div>
									<div class="form-group">
										<label>会员卡使用者</label> <input type="text"
											placeholder="请输入您要添加的会员卡办卡日期" class="form-control"
											name="vipWhoUse">
									</div>
									<div class="hr-line-dashed"></div>
									<div class="form-group">
										<label>会员办卡日期</label> <input id="vipdate"
											placeholder="请输入您要添加的会员卡办卡日期" class="form-control"
											name="vipDate">
									</div>
									<div class="hr-line-dashed"></div>
