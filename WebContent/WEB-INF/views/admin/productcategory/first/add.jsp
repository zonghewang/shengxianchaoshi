...
<shiro:hasPermission name="一级分类添加">
<!DOCTYPE html>
<html>
						...
						<form method="get" class="form-horizontal">
							<div class="form-group">
								...
								<div class="col-sm-10">
									...
									<input type="text" name="productCategoryName" class="form-control" onkeydown="if(event.keyCode==13){return false;}">
								</div>
							</div>
				...
				.ready(
						function() {
							$(".demo2")
									.click(function() {
												$.ajax({
													url: "${pageContext.request.contextPath}/admin/productcategory/first/add",
													type:"POST",
													data:$("form").serialize(),
													success: function(d){
														if(d.tips=="false"){
