			...
			<div class="ibox float-e-margins">
				<div class="ibox-title clearfix">
					...
					<div class="ibox-tools">
						<a
							href="${pageContext.request.contextPath}/admin/productcategory/first/add"
							class="btn btn-success btn-sm" target="_self">添加</a>
					</div>
				</div>
						...
						<tbody>
							<c:forEach var="productCategory" items="${productCategorys}"
								...
								<tr>
									...
									<td><c:out value="${productCategory.productCategoryName}"></c:out></td>
									<td>
										<div class="col-sm-12 h-100 p-lg">
											<shiro:hasPermission name="一级分类修改">
												<a
													href="${pageContext.request.contextPath}/admin/productcategory/first/update?pkPcid=${productCategory.pkPcid}"
													class="btn btn-primary btn-sm ">修改</a>
											</shiro:hasPermission>
											<shiro:hasPermission name="一级分类删除">
												<button class="btn btn-danger btn-sm demo4"
													data="${productCategory.pkPcid}">删除</button>
											</shiro:hasPermission>
										</div>
									</td>
								</tr>
												...
												swal(
														...
														function(isConfirm) {
															if (isConfirm) {
																...
																$
																		.ajax({
																			url : "${pageContext.request.contextPath}/admin/productcategory/first/delete?pkPcid="
																					+ $(
																							e.target)
																							.attr(
																									'data'),
																			...
																			success : function(
																				...
																				swal(
																						...
																						function(
																								isConfirm) {
																							if (isConfirm) {
																								window.location.href = '${pageContext.request.contextPath}/admin/productcategory/first/show';
																							} else {
