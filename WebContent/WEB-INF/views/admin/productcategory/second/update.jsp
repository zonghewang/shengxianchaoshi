									...
									<select class="form-control m-b" name="pid">
										<c:forEach var="firstProductCategory"
											...
											<option value="${firstProductCategory.pkPcid}"
												${firstProductCategory.pkPcid==productCategory.pid?'selected':''}>${firstProductCategory.productCategoryName}</option>
										</c:forEach>
									</select>
							...
							$(".demo2")
									.click(
											function() {
												$
														.ajax({
															url : "${pageContext.request.contextPath}/admin/productcategory/second/update?methord=update",
															type : "POST",
															data : $("form")
																	.serialize(),
															success : function(
																			...
																			function(
																				...
																				if (isConfirm) {
																					window.location.href = ctxpath
																							+ '/admin/productcategory/second/show';
																				} else {
