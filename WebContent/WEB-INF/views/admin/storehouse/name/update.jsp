							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" name="storehouseMax"
										value="${storehouseName.storehouseMax}">
								</div>
							</div>
							<div class="hr-line-dashed"></div>
							...
							$(".demo2")
									.click(
											function() {
												...
												$
														.ajax({
															url : "${pageContext.request.contextPath}/admin/storehouse/name/update?methord=update",
															type : "POST",
															data : $("form")
																	.serialize(),
															success : function(
